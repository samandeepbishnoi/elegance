...
const SpecialOffersCarousel: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-br from-red-50 via-pink-50 to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-100 to-pink-100 dark:from-red-900/30 dark:to-pink-900/30 px-4 py-2 rounded-full mb-4">
            <Zap className="h-4 w-4 text-red-600 dark:text-red-400 animate-pulse" />
            <span className="font-semibold text-sm text-red-900 dark:text-red-200">Limited Time Offers</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-gray-900 dark:text-white mb-3">
            Special Discounts
          </h2>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 sm:p-8"
              >
                {/* Product Image */}
                <div className="relative">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    className="relative h-64 sm:h-72 lg:h-80 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 cursor-pointer"
                  ...
                  >
                    ...
                    {currentProduct.discountInfo?.discountLabel && (
                      <div className="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-full font-bold text-xs sm:text-sm shadow-lg flex items-center gap-1 sm:gap-1.5 animate-bounce">
                ...
                <div className="flex flex-col justify-center">
                  <div className="inline-flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 mb-3">
                  ...
                  {currentProduct.discountInfo && (
                    <div className="mb-6">
                      ...
                      <div className="inline-block bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-3 py-1.5 rounded-lg text-sm">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => navigate(`/product/${currentProduct._id}`)}
                    className="w-full sm:w-auto bg-gradient-to-r from-red-500 to-pink-500 text-white px-6 py-3 rounded-full text-base font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                  >
          ...
          {discountedProducts.length > 1 && (
            <>
              <button
                onClick={handlePrev}
                className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-2 rounded-full shadow-lg hover:bg-white dark:hover:bg-gray-700 transition-all z-10"
              ...
              <button
                onClick={handleNext}
                className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-2 rounded-full shadow-lg hover:bg-white dark:hover:bg-gray-700 transition-all z-10"
