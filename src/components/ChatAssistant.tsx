  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 w-16 h-16 bg-gradient-to-r from-amber-600 to-amber-700 text-white rounded-full shadow-2xl flex items-center justify-center hover:shadow-amber-200 transition-shadow"
      >
